...
function initializeApp() {
  ...
  if (savedTheme) {
    ...
    setTheme("light"); // Set light as default instead of checking system preference
  }
  ...
  // Listen for system theme changes (optional - you can remove this if you don't want system theme to override)
  ...
  document.addEventListener("click", function (e) {
    if (
      e.target.classList.contains("downloadBtn") ||
      e.target.closest(".downloadBtn")
    ) {
      const button = e.target.classList.contains("downloadBtn")
        ? e.target
        : e.target.closest(".downloadBtn");
